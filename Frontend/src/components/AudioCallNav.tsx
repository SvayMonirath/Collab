...
export const AudioCallNav: React.FC<AudioCallNavProps> = ({ meetingTitle }) => {
    ...
    return (
        <nav className="flex flex-row fixed min-w-full bg-white! justify-between items-center px-4! py-4! bg-white z-[100]!">
            <div className="flex flex-row gap-4">
                <div className="text-blue-! bg-blue-700! p-2! rounded-xl size-fit!"><AudioLines className="size-3! sm:size-6! lg:size-8!"/></div>
            ...
            {/* Meeting timer */}
            <div className="hidden! sm:inline-block!  text-black! px-4! py-2! rounded-lg! text-xl! sm:text-2xl! lg:text-3xl! font-mono! font-semibold!">
                {meetingTime}
            </div>

            {/* Other Options */}
            <div className="flex flex-row gap-2! lg:gap-3! items-center!">
                <button className="hidden! bg-black! sm:inline-block! hover:scale-110! hover:border-none! transition-all! duration-300! text-white! px-4! py-2! lg:px-6! lg:py-3! rounded-xl! text-base! sm:text-lg! lg:text-xl! font-bold! lg:flex! flex-row items-center gap-2!">
