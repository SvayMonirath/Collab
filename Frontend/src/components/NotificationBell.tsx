...
export const NotificationBell: React.FC = () => {
                ...
                return (
                    <div className="relative! flex flex-row! gap-6! p-4! rounded-2xl! border border-gray-200! bg-white! hover:bg-gray-50! transition-all! duration-200!">
                        ...
                        <div className="flex! flex-col! items-end! gap-4!">
                            ...
                            <button
                                onClick={ () => {
                                    navigate(`${TeamHomeUrl}/${notification.team_id}`);
    ...
    <div className="">
        ...
        <Bell
            ...
            className={`w-4! h-4! text-gray-600! hover:cursor-pointer! md:w-6! md:h-6! ${isOpen ? "fill-black!" : ""}`}
        />

        {/* Notification Count */}
        <div
            className={`absolute! -top-1! -right-1! w-3! h-3! bg-red-500! text-white! text-xs! font-bold! rounded-full! flex! items-center! justify-center
            md:-top-2! md:-right-2! md:w-4! md:h-4! pointer-events-none!
        ...
        <div className="absolute! text-xs! right-8! top-12! w-[90%]! min-h-[40rem]! bg-white! rounded-xl! shadow-xl! z-50! sm:text-base! sm:right-12! sm:top-14! lg:right-28! lg:top-20! sm:w-1/2! lg:w-1/3! 2xl:w-1/4!">
            ...
            <span
                onClick={clickAllNotifications}
                className={`${
                AllNotificationsRead
                    ? "font-bold! underline underline-offset-6 text-black!"
                    : "text-gray-600!"
                } hover:cursor-pointer! transition-all! ease-in-out! duration-200!`}
            >
                All Notifications
            </span>
            ...
            {AllNotificationsRead && (
            <div>
                <div className="px-4 pt-6! bg-gray-50! rounded-b-xl! min-w-full! max-h-80! overflow-y-auto!">
                {notifications.length === 0 ? (
                    ...
                    <p className="text-black! font-medium! text-sm! pt-3! sm:pt-5! md:text-xl!">
                        You all caught up!
                    </p>
                    <p className="text-gray-500! text-center! px-3! text-xs! sm:px-10! sm:text-sm! md:text-base!">
                        No new notifications right now. We'll alert you when there's an update.
                    </p>
                    <p className="text-purple-700! mt-4! font-medium! hover:text-purple-800! cursor-pointer! sm:text-base! sm:mt-6!">
